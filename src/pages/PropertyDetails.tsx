...
export default function PropertyDetails() {
  ...
  const property = {
    ...
    baths: 5,
    sqft: 3200,
    description: 'Experience unparalleled luxury in this stunning modern villa located in the heart of Lekki Phase 1. Featuring high-end finishes, a private pool, smart home technology, and spacious living areas. Perfect for families looking for comfort and style.',
    images: [
      'https://picsum.photos/seed/villa1/1200/600',
    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px] md:h-[500px] rounded-2xl overflow-hidden">
        ...
        <div className="hidden md:flex flex-col gap-4 h-full">
          <img src={property.images[1]} alt="Interior 1" className="w-full h-1/2 object-cover rounded-tr-2xl" referrerPolicy="no-referrer" />
          <img src={property.images[2]} alt="Interior 2" className="w-full h-1/2 object-cover rounded-br-2xl" referrerPolicy="no-referrer" />
        </div>
      </div>
              ...
              <div className="pt-6 mt-6 border-t border-gray-100">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gray-200 overflow-hidden">
                    <img src="https://i.pravatar.cc/150?u=sarah" alt="Owner" referrerPolicy="no-referrer" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Listed by Owner</p>
                    <div className="flex items-center gap-1">
                      <p className="font-semibold text-gray-900">{property.owner.name}</p>
                      {property.owner.verified && <ShieldCheck className="w-4 h-4 text-green-500" />}
                    </div>
                  </div>
                </div>
              </div>
